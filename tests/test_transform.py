...
class TestTransform(UPSGTestCase):
    ...
    def test_rename_cols(self):
        ...
        trans_node['out'] > csv_write_node['input']
    ...
    def test_split_columns(self):
        ...
        csv_in['out'] > split['input']
        split['out'] > csv_out_sel['input']
    ...
    def test_query_complex(self):
        ...
        csv_in['out'] > q1_node['input']
        q1_node['out'] > csv_out['input']
    ...
    def test_query_dates(self):
        ...
        np_in['out'] > q2_node['input']

        np_out = p.add(NumpyWrite())
        q2_node['out'] > np_out['input']
    ...
    def test_fill_na(self):
        ...
        csv_in['out'] > fill_na['input']
        fill_na['out'] > csv_out['input']
    ...
    def test_kfold(self):
        ...
        np_in_X['out'] > kfold['input0']
        np_in_y['out'] > kfold['input1']
    ...
    def test_timify(self):
        ...
        timify = p.add(Timify())
        csv_in['out'] > timify['input']

        np_out = p.add(NumpyWrite())
        timify['out'] > np_out['input']
    ...
    def test_identity(self):
        trials = [(('input0', 'input1'), ('out0', 'out1'), 
                   {'input0': 'out0', 'input1': 'out1'},
                   True),
    ...
    def test_apply_to_selected_cols(self):
        ...
        for trans_cls, args, in_key, out_key, in_data in trials:
            ...
            node_in['out'] > node_ctrl_split['input']
